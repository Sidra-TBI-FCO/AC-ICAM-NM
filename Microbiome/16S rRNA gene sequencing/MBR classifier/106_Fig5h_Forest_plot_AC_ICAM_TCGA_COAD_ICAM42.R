...
# Load data
load(paste0("./Analysis/Exploration_reviewers/Microbiome/tumor_only_246/105_Collect_Data_for_forest_plot/105_HR_table_AC_ICAM_ICAM42_TCGA_COAD",
...
write.csv(results_df, file =paste0("./Analysis/Exploration_reviewers/Microbiome/tumor_only_246/105_Collect_Data_for_forest_plot/105_HR_table_AC_ICAM_ICAM42_TCGA_COAD",
          include_normal, ".csv"),
          row.names = FALSE)
...
svg(filename = paste0("./Figures/Exploration_reviewers/Microbiome/tumor_only_246/forestplot/foresplot_AC-ICAM_TCGA_COAD_ICAM42",
                      include_normal, ".svg"), 
    height = 2, width = 5)
...
pdf(file = paste0("./Figures/Exploration_reviewers/Microbiome/tumor_only_246/forestplot/forestplot_AC-ICAM_TCGA_COAD_ICAM42", 
                  include_normal,".pdf"),height = 3, width = 5)
forestplot(tabletext, 
           graph.pos = 2, # position of the graph 2 (after first column)
           cochrane_from_rmeta,new_page = FALSE,
           is.summary=c(TRUE,rep(FALSE,x),TRUE,rep(FALSE,x),TRUE,FALSE),
