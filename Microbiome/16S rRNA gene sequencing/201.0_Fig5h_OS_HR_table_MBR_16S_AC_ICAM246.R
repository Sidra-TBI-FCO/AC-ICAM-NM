...
results_df = data.frame(Survival = "16S-MBR score", HR = NA, p_val = NA, CI_lower = NA, CI_upper = NA, p_val_logrank = NA)
...
save(results_df, file = paste0("./Analysis/Exploration_reviewers/Microbiome/tumor_only_246/021_HR_tables_Median_and_continuous/HR_16S_MBR_Score_",survival,"_",cohort,"_samples_categorical.Rdata"))
