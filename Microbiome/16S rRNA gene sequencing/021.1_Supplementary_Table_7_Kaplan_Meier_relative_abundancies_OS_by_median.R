...
i = 372 # 277 (=Fusicatenibacter) # 371 (= Ruminococcus 1) # 372 (=Ruminococcus 2) # 419 Fusobacterium
for(i in 1:ncol(abundance_cat)){
 ...
 png(paste0("./Figures/Microbiome/021_KM_relative_abundance_groups/KM_", ICR, Type, "_abundance_in_", Tissue, "_tissue_", Rank,
            "_", micr, ".png"),
