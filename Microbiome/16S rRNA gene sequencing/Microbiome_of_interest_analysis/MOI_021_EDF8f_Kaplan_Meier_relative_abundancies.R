...
Tissue = "T"
ICR = "" # "" or "ICR High" or "ICR Medium" or "ICR Low"
...
i = 419 # 277 (=Fusicatenibacter) # 371 (= Ruminococcus 1) # 372 (=Ruminococcus 2) # 419 Fusobacterium
for(i in 1:ncol(abundance_cat)){
 ...
 pdf(paste0("./Figures/Microbiome/021_KM_relative_abundance_groups/EDF8f_KM_", ICR, Type, "_abundance_in_", Tissue, "_tissue_", Rank,
            "_", micr, ".pdf"),
...
save(results, file = paste0("./Analysis/Microbiome/021_KM_by_median/OS_KM_relative_abundance_by_median_", Tissue, ".Rdata"))
