...
#dir.create("./Figures/Microbiome/Microbiome_Of_Interest_Plots/006_EDF8g", showWarnings = FALSE)

#######################################
## boxplot ## 
pdf(file= paste0("./Figures/Microbiome/Microbiome_Of_Interest_Plots/006_EDF8g/16s_fusobacterium_tcell_two_groups_v3.pdf"),
    height = 2,width = 2)
...
# DF2
pdf(file = paste0("./Figures/Microbiome/Microbiome_Of_Interest_Plots/006_EDF8g/EDF8g_barplot_16s_fusobacterium_tcell.pdf"),
    height = 3,width = 3)
