...
# boxplot 
#dir.create("./Figures/Microbiome/Microbiome_Of_Interest_Plots/006_EDF8n", showWarnings = FALSE)
pdf(file = paste0("./Figures/Microbiome/Microbiome_Of_Interest_Plots/006_EDF8n/fusobacterium_nucleatum_tcell_two_groups_v2.pdf"),
    height = 2,width = 2)
...
# DF2
pdf(file = paste0("./Figures/Microbiome/Microbiome_Of_Interest_Plots/006_EDF8n/EDF8n_barplot_fuso_tcell_overall.pdf"),
    height = 3,width = 3)
