...
load("./Processed_Data/External_Data/Revised_TCGA_CLINICAL_DATA_CELL_2018_S1.Rdata")
...
TS.Alive = Merged_dataset[Merged_dataset$OS.PFI.Event == "0", c("OS.PFI.Event", "OS.PFI.Time", Group.of.interest, "ICRscore")]
colnames(TS.Alive) = c("Status","Time", Group.of.interest, "ICRscore")
TS.Alive$Time = as.numeric(as.character(TS.Alive$Time))
TS.Alive$Time[TS.Alive$Time > Y] = Y

TS.Dead = Merged_dataset[Merged_dataset$OS.PFI.Event == "1", c("OS.PFI.Event", "OS.PFI.Time", Group.of.interest, "ICRscore")]
...
png(paste0("./Figures/Kaplan Meier Plots/", download.method,"_", exclude_stage_IV ,"_Combined_OS_PFI_CMS_Surv_cutoff_years_", Surv.cutoff.years,".png"),
