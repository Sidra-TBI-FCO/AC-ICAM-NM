...
ICR = "ICR High"   # For Extended Data Figure 2g set to "ICR High" else ""
...
pdf(paste0("./Figures/Trimmed_p/005_ggsurv_plots/Fig1e_", ICR, "_",
           str_c(exclude, collapse = "_"), "_Overall_Survival_", Group.of.interest,"_Surv_cutoff_years_",Surv.cutoff.years,".pdf"),
